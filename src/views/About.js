      ...
      <div className="flex flex-col lg:flex-row justify-center">
        ...
        <div className="px-4 w-fit lg:pl-14 lg:flex items-center justify-center">
          <div className="">
            ...
            >
              <div className="py-2 flex text-4xl font-black w-fit gap-2 text-slate-800 dark:text-slate-50">
              ...
              <p className="font-montserrat dark:text-slate-100 text-slate-600 smooth leading-normal text-base font-extralight text-justify">
                I am front-end developer based in the city of Baubau, Indonesia. I am also student at Haluoleo
            ...
            <div className="mt-6 px-4 w-full justify-between flex items-center">
              <div className="text-2xl mt-1 flex items-center gap-4 text-indigo-800/75 dark:text-indigo-200">
                <span className="inline-block"><a className="" href="https://github.com/asmindev" aria-label="asu"><ion-icon name="logo-github" /></a></span>
                <span className="inline-block"><a className="" href="https://instagram.com/iniasmin_" aria-label="asu"><ion-icon name="logo-instagram" /></a></span>
              </div>
              {/* Contact email */}
              <div className="">
                <span className="block">
                  <a className="flex gap-2 px-4 py-3 rounded bg-indigo-400 text-slate-50 text-sm" href="mailto:asminmin477@gmail.com">
