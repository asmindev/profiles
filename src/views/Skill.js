  ...
  return (
    <div className="px-4">
      ...
      >
        ...
        <div className="w-11/12 mx-auto mt-8 flex flex-wrap">
          <div className="text-slate-700 dark:text-slate-100 smooth">
            <p className="text-justify text-base">
              {/* prettier-ignore */}
              {'I\'m honing my Front-End skills from mid 2021 Until now. I have experience but but I\'m no expert. I really enjoy learning:'}
            </p>
          </div>
          <div className="w-1/2">
            <div className="p-2 overflow-hidden">
              ...
              >
                ...
                <h1 className="mt-12 text-center">Python</h1>
              </motion.div>
            </div>
          </div>
          <div className="w-1/2">
            <div className="p-2 overflow-hidden">
              ...
              >
                ...
                <h1 className="mt-12 text-center">Javascript</h1>
              </motion.div>
            </div>
          </div>
          <div className="w-1/2">
            <div className="p-2 overflow-hidden">
              ...
              >
                ...
                <h1 className="mt-12 text-center">ReactJs</h1>
              </motion.div>
            </div>
          </div>
          <div className="w-1/2">
            <div className="p-2 overflow-hidden">
              ...
              >
                ...
                <h1 className="mt-12 text-center">TailwindCSS</h1>
              </motion.div>
            </div>
          </div>
        </div>
